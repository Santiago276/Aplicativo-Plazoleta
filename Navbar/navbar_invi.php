...
<head>
    ...
    <title>Invitado | Plazoleta</title>
    <!-- Favicon-->
...
<body id="page-top" style="background-color: rgb(255, 227, 203);">
    <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav" background-color=#010304;>
        <div class="container">
            ...
            <a align="left" href="/index.php"><img width="160" src="/img/íconos/plaznegro.png" alt=""></a>
            <div class="collapse navbar-collapse" id="navbarResponsive" id="letra">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/menu.php">Menú</a></li>
                    ...
                    <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="/Usuario/iniciar sesion.php">Iniciar sesión</a></li>
                </ul>
            </div>
        </div>
    </nav>
